...
import { Bell, ChevronDown, Clock3, Database, Fingerprint, Gift, KeyRound, ListChecks, LogOut, MonitorSmartphone, Receipt, RefreshCcw, Settings, ShieldCheck, SquareActivity, Timer, Trophy } from 'lucide-react';
